      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 view-trigger">
            ...
            <a
              href="mailto:minsang1233@gmail.com"
              className="text-primary hover:text-primary/80 font-medium border-b border-primary/30 hover:border-primary transition-colors"
            >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
            <div className="flex gap-4">
              <Button
                ...
                asChild
              >
                <a href="mailto:minsang1233@gmail.com" target="_blank" rel="noopener noreferrer">
              ...
              <Button
                ...
                asChild
              >
                <a href="https://github.com/minsang-dev" target="_blank" rel="noopener noreferrer">
                  <Github className="h-5 w-5" />
                </a>
              </Button>
            </div>
            <p className="text-slate-500 text-sm">© 2025 Kim Min Sang. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
